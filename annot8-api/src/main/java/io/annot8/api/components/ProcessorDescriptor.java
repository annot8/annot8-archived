 ...
 * @param <T>
 *      The Annot8 processor described by this descriptor
 * @param <S>
 *      The settings used by this processor, or {@link io.annot8.api.settings.NoSettings} if the component doesn't use settings
 */
