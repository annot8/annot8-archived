 ...
 *
 * Descriptors provide contextual information about a component, for example a name and it's configuration,
 * as well as a method to create an instance of that component.
 *
 * Descriptors should be serializable, as they can be used to recreate pipelines.
 *
 * @param <T>
 *      The Annot8 component described by this descriptor
 * @param <S>
 *      The settings used by this component, or {@link io.annot8.api.settings.NoSettings} if the component doesn't use settings
 */
